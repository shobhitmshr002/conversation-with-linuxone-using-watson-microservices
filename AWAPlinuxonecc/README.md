# Cognitive Hybrid Cloud Services through IBM Watson Assistant


This journey will consist in a Node.js application running in a docker container, hosted on IBM Cloud Private, capable to provide cloud services on IBM LinuxONE Systems through a human conversation using IBM Watson APIs in IBM Cloud (Public).
